...
module.exports = {
    entry: './src/js/index.js', // 打包的入口，可以有多个 entry []
    ...
    module: {
        rules: [ // 当前版本已经不支持 loaders
            ...
            {
                test: /\.css$/,
                loader: "style!css" // style!css类似一种输出重定向，css-loader的输出会作为style-loader的输入, 从右往左开始处理
            },
            {
                test: /\.css$/,
                loaders: ["style", "css", "less"], //推荐这种写法
            }
        ]
    },
    resolve: {
